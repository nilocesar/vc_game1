events.on('ready', function() {
	...
	$('.container-exercise-quiz').each(function(indice, item) {
			...
			var direct = ($(_template).attr('direct')) ? $(_template).attr('direct') : false;
			var standardBtn = ($(_template).attr('standardBtn')) ? $(_template).attr('standardBtn') : false;
			var repeatBtn = ($(_template).attr('repeatBtn')) ? $(_template).attr('repeatBtn') : false;
			var cacheBtn = ($(_template).attr('cacheBtn')) ? $(_template).attr('cacheBtn') : false;
			...
			if (random) {
					$(_template).find('.wrapper-altervatives').html(
							$(_template).find('.wrapper-altervatives .container-alternative').sort(function() {
			...
			function reset() {
					...
					if( standardBtn!=false ){
						...
						$(_template).find('.button-confirm .txtConfirm').css('display', 'block');
			...
			$(_template).find('.modal-close').on('click focusin', function() {
					...
					if (repeat <= 0) {
							...
							if(cacheBtn != false ){
									...
									$(_template).find('.button-confirm .txtBtn').css('display', 'none');
									$(_template).find('.button-confirm .txtCache').css('display', 'block');
									saveCache();
							}
							...
							if(repeatBtn != false){
								...
								$(_template).find('.button-confirm .txtBtn').css('display', 'none');
								$(_template).find('.button-confirm .txtRepeat').css('display', 'block');
							}
