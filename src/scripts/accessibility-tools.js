...
events.on('ready', function() {
    ...
    var invertColorsTXT = 'Inverter cores';
    var grayHuesTXT = 'Tonalidade cinza';
    var underlineLinksTXT = 'Sublinhar links';
    var bigCursorTXT = 'Aumentar o cursor';
    var idioma = 'pt-BR';

    var language = navigate.currentScreen.model.language;
	if(language == "es"){
        invertColorsTXT = 'Invertir colores';
        grayHuesTXT = 'Tono gris';
        underlineLinksTXT = 'Subrayar enlaces';
        bigCursorTXT = 'Agrandar el cursor';
        idioma = 'es';
	}
	else if(language == "en"){
		invertColorsTXT = 'Invert colors';
        grayHuesTXT = 'Grayscale';
        underlineLinksTXT = 'Underline links';
        bigCursorTXT = 'Enlarge mouse pointer';
        idioma = 'en';
	}
    ...
    labels: {
        ...
        invertColors: invertColorsTXT,
        grayHues: grayHuesTXT,
        underlineLinks: underlineLinksTXT,
        bigCursor: bigCursorTXT,
        readingGuide: 'reading guide (in my language)',
        textToSpeech: 'text to speech (in my language)',
        speechToText: 'speech to text (in my language)'
    },
    textToSpeechLang: idioma,
    speechToTextLang: idioma,
    // textPixelMode: true,
    hotkeys: {
        enabled: true
    },
...
function createTools(acessOptions) {
