events.on("ready", function () {
  ...
  var container_ballon = $(".container-ballon-quiz");
  var _ind = 0;
  var indice = 0;
  var _intPrev = true;
  var _lastNext = false;
  ...
  if (container_ballon.length > 0) {
    ...
    // $(".ballon-bonus-fase4")
    //   .find(".btn-ballon-next")
    //   .on("click", function () {
    //     navigate.goto("40_tela");
    //   });
    ...
    container_ballon.find(".btn-ballon-quiz").on("click", function () {
      if (!_lastNext) container_ballon.trigger("next");
      else navigate.next();
    });
